    ...
    return {
        ...
        addListItem: function(obj, type){
            ...
            if (type === 'inc'){
                ...
                '<div class="item clearfix" id="expense-%id%"><div class="item__%description%">Apartment rent</div><div class="right clearfix"><div class="item__%value%">- 900.00</div><div class="item__percentage">21%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>'
            }
